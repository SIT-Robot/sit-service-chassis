...
ist8310_real_data_t ist8310_real_data = {0,0,0};
...
static fp32 INS_angle[3] = {0.0f, 0.0f, 0.0f};      //euler angle, unit rad.欧拉角 单位 rad
...
void INS_task(void const *pvParameters)
{
  // uint8_t ist_oled[20];
    ...
    while (1)
    {
        ...
        // sprintf((char*)ist_oled,":%.2f,%.2f,%.2f",ist8310_real_data.mag[0],ist8310_real_data.mag[1],ist8310_real_data.mag[2]);
        // HAL_UART_Transmit(&huart6,ist_oled,sizeof(ist_oled),20);
        // OLED_show_string(0,0,ist_oled);
/*
